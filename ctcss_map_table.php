 ...
 function validate_export() 
 {
  ...
  <div class="form-group">
    ...
    <fieldset class="form-group row">
              <label for="Softwareinput" class="col-2 col-form-label">Software</label>
  		<div class="col-10">  
          ...
          <label for="numberinpuet" class="col-2 col-form-label">CSV index</label>
          <div class="col-10">
            <input class="form-control" type="number" value="0" name="index" id="numberinpuet">
          </div>
          
          <label for="countrypre" class="col-2 col-form-label">Use thre last char in call</label>
          <div class="col-10">
