...
$('#Reflektortable').html('<th><?php echo _("Callsign")?></th><th><?php echo _("TG#")?></th><th><?php echo _("Is talker")?></th><th><?php echo _("Monitored TGs")?></th><th class="d-none d-md-table-cell" ><?php echo _("Talk time")?></th><th class="d-none  d-md-table-cell" ><?php echo _("Active RX")?></th>');
for(var k in data.nodes){
	node_count++;
	var text =" ";
	...
	{
         $('#Reflektortable').append('<tr><td>'+k+'</td>'+'<td>'+data.nodes[k].tg+'</td>'+'<td class="green_collor" ><?php echo _("YES")?>'+image+'</td><td class="text-primary">'+text+'</td><td  class="d-none d-md-table-cell" ><label id="minutes">00</label>:<label id="seconds">00</label></td><td  class="d-none d-md-table-cell" ></td></tr>');
           ++totalSeconds;
